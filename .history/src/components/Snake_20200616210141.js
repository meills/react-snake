...
class Snake extends React.Component {
    ...
    gameTick() {
        ...
        this.setState({food: newFood, snake: { head: {row: newRow, col: newCol}, tail: tail, prevTailStart: head}});
    ...
    initGrid() {
        ...
        const snake = {head: this.getGridCenter(), tail: [], prevHead:{},};
    ...
    checkGameOver() {
        ...
        if (this.state.snake.tail.length > 0) {
            if(this.state.snake.prevHead.row === this.state.snake.tail[0].row && this.state.snake.prevHead.col === this.state.snake.tail[0].col) {
                this.props.endGame();
                return true;
            }
    ...
    handleKeyPress(e) {
        ...
        switch (key) {
            ...
            case 'ArrowLeft':
                ...
                break;
            case 'KeyT': 
                document.getElementById('food').style.backgroundImage = 'url(\'../images/totorro.jpg\')';
                break;
            default:
                break;
        }
